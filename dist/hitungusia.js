export function hitungUsiaLengkap(tahunLahir, bulanLahir = 1, hariLahir = 1, referensi = new Date()) {
    ...
    if (hari < 0) {
        const prevMonthLastDay = new Date(referensi.getFullYear(), referensi.getMonth(), 0).getDate();
